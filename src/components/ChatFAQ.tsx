...
const defaultFAQItems: FAQItem[] = [
  {
    ...
    answer:
      '아니요. Night Call Audio는 별도의 회원가입이나 로그인 과정이 필요 없습니다. 결제 시 입력하신 이메일 주소만으로 간편하게 구매하실 수 있으며, 구매 내역은 이메일 주소 입력만으로 언제든 확인 가능합니다.',
  },
  {
    id: 2,
    question: '결제 방식은 어떻게 되나요?',
    answer:
      '현재 [무통장 입금]과 [카카오페이 송금] 방식을 지원합니다. Night Call Audio는 아티스트 간의 불필요한 수수료를 없애기 위해 개인 간 직거래 방식을 채택하고 있으며, 이는 현행법상의 개인 간 상거래 규정을 준수하는 안전한 방식입니다. 결제 시 안내되는 계좌로 입금을 완료하시면 확인 후 즉시 다운로드 권한이 승인됩니다.',
  },
  {
    id: 3,
    question: '구매한 제품은 어디서 다운로드하나요?',
    answer:
      '상단 메뉴의 [내 구매] 탭을 클릭하신 후, 구매 시 사용한 이메일 주소를 입력해 주세요. 별도의 인증 코드 없이도 실시간으로 입금 확인 상태와 다운로드 링크를 곧바로 확인하실 수 있습니다.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      '디지털 상품의 특성상, 결제가 완료되고 다운로드 권한이 부여된 시점부터는 어떠한 사유로도 환불 및 교환이 불가능합니다. 구매 전 상품 상세 페이지의 기술 스펙과 설명을 충분히 확인해 주시기 바랍니다.',
  },
  {
    id: 6,
