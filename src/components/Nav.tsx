    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="glass border-b border-border">
        <nav className="max-w-[1440px] mx-auto px-8 md:px-12 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 md:gap-3.5 group transition-all">
            <div className="relative w-6 h-6 md:w-10 md:h-10 group-hover:scale-110 transition-transform duration-500 ease-out">
              <Image
                src="/nca_logo.svg"
                alt="Logo"
                fill
            ...
            <span className="font-display font-extrabold text-sm md:text-xl tracking-tighter text-text-primary group-hover:text-accent transition-colors">
              Night Call Audio
            </span>
          </Link>
